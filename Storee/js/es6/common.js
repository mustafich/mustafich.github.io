...
if(screen.width>993){
    document.onscroll = function () {
        window.pageYOffset >= 150
            ? filterTop1.classList.add('topFix')
            :filterTop1.classList.remove('topFix');
...
selects.forEach(function (select, index) {
    ...
    for(var i = 0 ;i<choose.length; i++) {
        choose[i].onclick = function () {
            ...
            toChoose.querySelector('.hide').innerHTML =
...
var buttonSubmit = document.querySelector('.main-container_filters-inner_button-filter');
